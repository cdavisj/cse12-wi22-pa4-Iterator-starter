...
/**
 * To run tester:
 * $ javac -cp ".;libs\junit-4.12.jar;libs\hamcrest-core-1.3.jar" MyLinkedListPublicTester.java
 * $ java -cp ".;libs\junit-4.12.jar;libs\hamcrest-core-1.3.jar" org.junit.runner.JUnitCore MyLinkedListPublicTester
 */
...
public class MyLinkedListPublicTester {
        ...
        /**
         * Standard Test Fixture. A list with one entry and a list with two
         * entries
         */
        @Before
        public void setUp() {
        ...
        public void testConstructor() {
                ...
                assertEquals("The index of the element the iterator is initially pointing"
                                + " on", 0, listLen1Iter.idx);
                assertEquals("The data of initial iterator's left",
                                listLen1.head, listLen1Iter.left);
                assertEquals("The data of initial iterator's left", null,
                                listLen1Iter.left.data);
                assertEquals("The data of initial iterator's right",
                                "Christine", listLen1Iter.right.data);
        }
        ...
        public void testNextOneCall() {
                assertEquals("The element returned from calling next",
                                "Christine", listLen1Iter.next());
                assertEquals("Index of iterator after 1 next()", 1,
                                listLen1Iter.idx);
        ...
        public void testNextTwoCalls() {
                ...
                assertEquals("The element returned from calling next", "Cao",
                                listLen2Iter.next());
                assertEquals("Index of iterator after 2 next()", 2,
                                listLen2Iter.idx);
        ...
        public void testPreviousOneCall() {
                ...
                assertEquals("The element returned from calling previous",
                                "Christine", listLen1Iter.previous());
        ...
        public void testPreviousNoPrevious() {
                ...
                assertFalse("Direction is not forward", listLen1Iter.forward);
                try {
                        listLen1Iter.previous(); // Should throw
        ...
        public void testNextIndex() {
                assertEquals("Index before any moves", 0,
        ...
        public void testSetBackward() {
                ...
                assertEquals("Valid set when backward", "Did it change?",
                                listLen2Iter.right.getElement());
                assertEquals("Valid set when backward, shouldn't change",
                                "Paul", listLen2Iter.left.getElement());
        }
        ...
        public void testRemoveForward() {
                ...
                assertEquals("Valid remove when forward", null,
                                listLen2Iter.left.getElement());
                assertEquals("Valid remove when forward, shouldn't change",
                                "Cao", listLen2Iter.right.getElement());
        ...
        public void testRemoveBackward() {
                ...
                assertEquals("Valid remove when forward", null,
                                listLen2Iter.right.getElement());
                assertEquals("Valid remove when backward, shouldn't change",
                                "Paul", listLen2Iter.left.getElement());
